  ...
  return (
    <div className="py-20 px-28">
      ...
      <div className="relative px-20 py-16">
        ...
        <button
          className="absolute top-1/2 left-6 transform -translate-y-1/2 bg-transparent rounded-full border-2 border-black/60 text-black/60 hover:bg-black hover:text-white transition duration-300 font-extrabold text-lg w-10 h-10"
          onClick={() => sliderRef.current.slickPrev()} // Go to previous slide
        >
          &#60;
        </button>
        <button
          className="absolute top-1/2 right-6 transform -translate-y-1/2 bg-transparent rounded-full border-2 border-black/60 text-black/60 hover:bg-black hover:text-white transition duration-300 font-extrabold text-lg w-10 h-10"
